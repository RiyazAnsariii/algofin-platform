...
export default function ExchangesPage() {
  ...
  return (
    <div className="w-full max-w-[1440px] mx-auto h-[calc(100vh-3.25rem)] flex flex-col justify-between text-foreground font-sans gap-2 overflow-hidden">
      ...
      <div className="space-y-2 shrink-0">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            ...
            className="px-3 py-1 rounded-xl border border-white/10 text-muted-foreground hover:text-foreground text-xs font-medium bg-white/5 hover:bg-white/10 transition-all flex items-center gap-1.5 shrink-0"
          >
            View Documentation ↗
          </button>
        </div>
        ...
        <div className="bg-[#081b22]/90 border border-cyan-500/25 rounded-xl p-2 px-3 flex items-center gap-2.5 shadow-sm">
          ...
          <div className="flex items-center gap-1">
            {[
              ...
              <button
                ...
                className={`px-3 py-0.5 rounded-lg text-xs font-medium transition-all whitespace-nowrap ${
                  activeFilter === tab.id
      ...
      {/* ── MAIN CONTENT GRID (Fits 100% on Single Screen without Vertical Scrollbar) ── */}
      <div className="flex flex-col gap-2 flex-1 min-h-0 justify-between">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 flex-1 min-h-0">
            {filteredExchanges.map(ex => {
              ...
              if (isConnected) {
                ...
                return (
                  <div key={ex.id} className="relative bg-[#070c16]/95 border border-[#0d2238] rounded-2xl p-3 px-3.5 flex flex-col justify-between shadow-xl transition-all hover:border-[#133252] min-h-0">
                    {/* Top Header Row */}
                    ...
                    <div className="flex flex-wrap items-center gap-1.5 text-[10px] text-muted-foreground">
                      <span className="px-2.5 py-0.5 rounded-md bg-[#071828] border border-cyan-500/20 text-cyan-400 font-medium flex items-center gap-1">
                        🔒 Read-only API
                      </span>
                      <span className="px-2.5 py-0.5 rounded-md bg-[#071828] border border-cyan-500/20 text-cyan-400 font-medium flex items-center gap-1">
                        🔄 Portfolio Sync
                    ...
                    <div className="flex items-end justify-between pt-1 border-t border-white/6 gap-2">
              ...
              // ── NOT CONNECTED CARD ───────────────────────────────────────────────────
              return (
                <div key={ex.id} className="bg-[#0b101b]/90 border border-white/8 hover:border-white/16 rounded-2xl p-3 px-3.5 flex flex-col justify-between shadow-md min-h-0">
                  <div className="space-y-1.5">
                    {/* Header */}
                    <div className="flex items-start justify-between gap-2">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <p className="text-[11px] text-muted-foreground font-medium">{ex.display_name.replace(ex.name, "").trim() || ex.markets.join(" · ")}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Feature Tags */}
                    <div className="flex flex-wrap items-center gap-1.5 text-[10px] text-muted-foreground">
                      <span className="px-2.5 py-0.5 rounded-md bg-white/4 border border-white/6 flex items-center gap-1">🔒 Read-only API</span>
                      <span className="px-2.5 py-0.5 rounded-md bg-white/4 border border-white/6 flex items-center gap-1">🔄 Portfolio Sync</span>
                      <span className="px-2.5 py-0.5 rounded-md bg-white/4 border border-white/6 flex items-center gap-1">⏱ Trade History</span>
                    </div>
                  ...
                  <div className="pt-1">
                    <button
                      ...
                      className="w-full py-2 rounded-xl bg-[#061e2b]/60 border border-cyan-500/30 text-cyan-400 text-xs font-semibold hover:bg-cyan-500/15 hover:border-cyan-500/50 transition-all flex items-center justify-center gap-1.5 shadow-sm"
                    >
                      Connect Account →
                    </button>
                  </div>
        ...
        <div className="shrink-0 bg-[#06151f]/80 border border-cyan-500/15 rounded-xl px-3.5 py-1.5 flex items-center justify-between gap-2 text-xs text-muted-foreground shadow-sm">
          <div className="flex items-center gap-2">
