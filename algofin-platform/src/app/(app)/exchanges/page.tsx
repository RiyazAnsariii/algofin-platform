...
export default function ExchangesPage() {
  ...
  return (
    <div className="w-full max-w-[1440px] mx-auto h-[calc(100vh-3rem)] flex flex-col justify-between text-foreground font-sans gap-2 overflow-hidden px-5 sm:px-8">
      {/* ── TOP AREA ────────────────────────────────────────────────────── */}
