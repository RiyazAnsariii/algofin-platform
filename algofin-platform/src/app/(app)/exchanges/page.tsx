...
// AlgoFin v2 — Phase H: Multi-Exchange support & Full Viewport Height Interface
...
// ── Main Page (Stretches to Full Viewport Height) ────────────────────────
export default function ExchangesPage() {
  ...
  return (
    <div className="w-full max-w-[1440px] mx-auto min-h-[calc(100vh-3.5rem)] flex flex-col justify-between space-y-3 text-foreground font-sans pb-1">
      {/* ── TOP AREA (Header + Security + Stats + Filters) ───────────────── */}
      <div className="space-y-3 shrink-0">
        ...
        <div className="bg-[#081b22]/90 border border-cyan-500/25 rounded-2xl p-3.5 px-4 flex items-center gap-3 shadow-md shadow-cyan-950/20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div className="bg-[#0b101b]/80 border border-white/8 rounded-2xl p-3.5 px-4 flex items-center gap-3">
      ...
      {/* ── MAIN CONTENT GRID (FILLS REMAINING VERTICAL HEIGHT) ──────────── */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 flex-1 items-stretch min-h-0">
        ...
        <div className="lg:col-span-8 flex flex-col justify-between space-y-3 h-full">
          ...
          {loading && showSkeleton && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 flex-1">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="bg-[#0b101b] border border-white/8 rounded-2xl p-4 space-y-3 flex flex-col justify-between">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 flex-1 min-h-0">
              {filteredExchanges.map(ex => {
                ...
                if (isConnected) {
                  // ── CONNECTED CARD ────────────────────────────────
                  return (
                    <div key={ex.id} className="relative bg-[#071918]/80 border-2 border-emerald-500/40 rounded-2xl p-4 space-y-3 flex flex-col justify-between shadow-lg shadow-emerald-950/10">
                ...
                return (
                  <div key={ex.id} className={`bg-[#0b101b]/80 border rounded-2xl p-4 space-y-3 flex flex-col justify-between transition-all ${
          ...
          {/* Bottom Info Strip */}
          <div className="bg-[#0a0f19]/60 border border-white/6 rounded-2xl px-4 py-2.5 flex items-center justify-between gap-2 text-xs text-muted-foreground shrink-0">
            <div className="flex items-center gap-2">
        ...
        {/* ── RIGHT COLUMN: SIDEBAR INFO PANEL (STRETCHES FULL HEIGHT 4 COLS) ─ */}
        <div className="lg:col-span-4 flex flex-col justify-between space-y-3 h-full">
          {/* Card 1: How it works (Timeline) */}
          <div className="bg-[#0b101b]/90 border border-white/8 rounded-2xl p-4 space-y-3 flex-1 flex flex-col justify-center">
          ...
          {/* Card 3: Need Help? (Aligned with bottom Sign out line) */}
