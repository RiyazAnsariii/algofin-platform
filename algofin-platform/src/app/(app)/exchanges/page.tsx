...
export default function ExchangesPage() {
  ...
  return (
    <div className="w-full max-w-[1440px] mx-auto flex flex-col text-foreground font-sans gap-3.5 pb-6">
      {/* ── TOP AREA ────────────────────────────────────────────────────── */}
      <div className="space-y-3 shrink-0">
        ...
        <div className="bg-[#081b22]/90 border border-cyan-500/25 rounded-2xl p-3 px-4 flex items-center gap-3 shadow-sm">
      ...
      <div className="flex flex-col gap-3.5">
        ...
        {/* Cards Grid (Natural Content Height - No Giant Empty Voids!) */}
        {!loading && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
            {filteredExchanges.map(ex => {
              ...
              if (isConnected) {
                ...
                return (
                  <div key={ex.id} className="relative bg-[#070c16]/95 border border-[#0d2238] rounded-2xl p-4 flex flex-col gap-3.5 shadow-xl transition-all hover:border-[#133252]">
                    {/* Top Header Row */}
              ...
              // ── NOT CONNECTED CARD (Clean Natural Compact Height) ──────────────────────────────
              return (
                <div key={ex.id} className="bg-[#0b101b]/90 border border-white/8 hover:border-white/16 rounded-2xl p-4 flex flex-col gap-3 transition-all shadow-md">
                  {/* Header */}
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-center gap-3">
                      <ExchangeLogo id={ex.id} name={ex.name} />
        ...
        {/* Bottom Info Strip */}
        <div className="bg-[#06151f]/80 border border-cyan-500/15 rounded-2xl px-4 py-3 flex items-center justify-between gap-2 text-xs text-muted-foreground shadow-sm mt-1">
          <div className="flex items-center gap-2">
