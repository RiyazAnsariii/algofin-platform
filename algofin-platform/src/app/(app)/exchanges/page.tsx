...
// AlgoFin v2 — Phase H: Multi-Exchange support & Perfect Viewport Fit Interface
...
// ── Main Page (Fits Exactly in Viewport) ────────────────────────
export default function ExchangesPage() {
  ...
  return (
    <div className="w-full max-w-[1440px] mx-auto space-y-2 text-foreground font-sans">
      {/* ── TOP AREA ────────────────────────────────────────────────────── */}
      <div className="space-y-2 shrink-0">
        ...
        <div className="bg-[#081b22]/90 border border-cyan-500/25 rounded-xl py-2 px-3 flex items-center gap-2.5 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2.5">
          ...
          <div className="bg-[#0b101b]/80 border border-white/8 rounded-xl py-2 px-3 flex items-center gap-2.5">
      ...
      {/* ── MAIN CONTENT GRID (COMPACT VIEWPORT FIT) ─────────────────────────── */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-2.5 items-start">
        ...
        <div className="lg:col-span-8 space-y-2">
          ...
          {loading && showSkeleton && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="bg-[#0b101b] border border-white/8 rounded-xl p-2.5 space-y-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
              {filteredExchanges.map(ex => {
                ...
                if (isConnected) {
                  // ── CONNECTED CARD ────────────────────────────────
                  return (
                    <div key={ex.id} className="relative bg-[#071918]/80 border-2 border-emerald-500/40 rounded-xl p-2.5 space-y-2 shadow-md">
                      {/* Header */}
                      ...
                      <div className="grid grid-cols-2 gap-y-0.5 gap-x-2 text-[10px] text-muted-foreground">
                      ...
                      <div className="flex items-center gap-1.5 pt-0.5">
                        <button
                          ...
                          className="flex-1 py-1 rounded-lg bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 border border-emerald-500/25 text-[11px] font-semibold transition-all flex items-center justify-center gap-1"
                        >
                          ⚙ Manage Account
                        </button>
                ...
                return (
                  <div key={ex.id} className={`bg-[#0b101b]/80 border rounded-xl p-2.5 space-y-2 flex flex-col justify-between transition-all ${
                    ...
                    <div className="space-y-1.5">
                      ...
                      {/* Description */}
                      <p className="text-[10.5px] text-muted-foreground/90 leading-tight line-clamp-2">
                        {ex.description}
                      </p>
                    </div>
          ...
          {/* Bottom Info Strip */}
          <div className="bg-[#0a0f19]/60 border border-white/6 rounded-xl px-3 py-1.5 flex items-center justify-between gap-2 text-[11px] text-muted-foreground shrink-0">
            <div className="flex items-center gap-1.5">
        ...
        <div className="lg:col-span-4 space-y-2">
          ...
          <div className="bg-[#0b101b]/90 border border-white/8 rounded-xl p-2.5 space-y-2">
            <h2 className="text-[10px] font-bold text-foreground tracking-wide uppercase text-muted-foreground/80">How it works</h2>

            <div className="relative pl-5 space-y-2 before:absolute before:left-[9px] before:top-2 before:bottom-2 before:w-[2px] before:bg-white/10">
              {/* Step 1 */}
              <div className="relative">
                <div className="absolute -left-5 top-0 w-4.5 h-4.5 rounded-full bg-purple-500/20 border border-purple-500/40 text-purple-400 text-[10px] font-bold flex items-center justify-center shrink-0">
                  1
                </div>
              ...
              {/* Step 3 */}
              <div className="relative">
                <div className="absolute -left-5 top-0 w-4.5 h-4.5 rounded-full bg-cyan-500/20 border border-cyan-500/40 text-cyan-400 text-[10px] font-bold flex items-center justify-center shrink-0">
                  3
                </div>
                <div className="pl-1.5 space-y-0">
              ...
              {/* Step 4 */}
              <div className="relative">
                <div className="absolute -left-5 top-0 w-4.5 h-4.5 rounded-full bg-blue-500/20 border border-blue-500/40 text-blue-400 text-[10px] font-bold flex items-center justify-center shrink-0">
                  4
                </div>
                <div className="pl-1.5 space-y-0">
          ...
          <div className="bg-[#0b101b]/90 border border-white/8 rounded-xl p-2.5 space-y-1.5">
            <h2 className="text-[10px] font-bold text-foreground tracking-wide uppercase text-muted-foreground/80">Why Connect Your Exchange?</h2>
          ...
          {/* Card 3: Need Help? */}
          <div className="bg-[#0b101b]/90 border border-white/8 rounded-xl p-2.5 space-y-1.5">
            <h2 className="text-[10px] font-bold text-foreground tracking-wide uppercase text-muted-foreground/80">Need Help?</h2>
            <p className="text-[10px] text-muted-foreground leading-tight">
