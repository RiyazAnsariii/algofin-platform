    ...
    <div className="surface-card p-3.5 space-y-1.5">
      ...
      {loading ? (
        <div className="space-y-1.5">
          ...
          {sub && <div className="skeleton h-2.5 w-16" />}
        </div>
      ) : (
        <>
...
function PositionRow({
  ...
  return (
    <div className="flex items-center justify-between px-3.5 py-2.5 text-xs border-b border-white/4 last:border-0">
...
function StaleBanner({ freshness }: { freshness: PortfolioSummary["data_freshness"] }) {
  ...
  return (
    <div className="px-3.5 py-2 rounded-xl bg-amber-500/8 border border-amber-500/20 text-xs flex items-start gap-2">
...
// ── No exchange section (compact single-screen fit) ─────────────
function NoExchangeSection() {
  return (
    <div className="space-y-3 animate-fade-in">
      {/* Hero Card */}
      <div className="relative surface-card py-5 px-6 text-center overflow-hidden border border-white/8 rounded-2xl bg-gradient-to-b from-cyan-500/[0.02] via-transparent to-transparent">
        {/* Concentric rings pattern background */}
        <div className="absolute inset-0 pointer-events-none opacity-20 flex items-center justify-center">
          <div className="w-[240px] h-[240px] rounded-full border border-cyan-500/20 flex items-center justify-center">
            <div className="w-[170px] h-[170px] rounded-full border border-cyan-500/15 flex items-center justify-center">
              <div className="w-[100px] h-[100px] rounded-full border border-cyan-500/10" />
            </div>
          </div>
        </div>

        <div className="relative z-10 space-y-2.5 max-w-sm mx-auto">
          <div className="w-11 h-11 rounded-full bg-cyan-500/10 border border-cyan-500/30 flex items-center justify-center mx-auto text-cyan-400 shadow-glow-cyan-sm">
          ...
          <div>
            <h2 className="text-lg font-bold text-foreground tracking-tight">Connect your account</h2>
          ...
          <div className="pt-1">
            <Link
              href="/exchanges"
              className="inline-flex items-center gap-1.5 px-5 py-2 rounded-xl bg-cyan-400 hover:bg-cyan-300 text-black
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2.5">
          {/* Portfolio Tracking */}
          <div className="surface-card p-3 rounded-xl border border-white/6 flex flex-col justify-between space-y-2 hover:border-white/12 transition-all">
      ...
      {/* Security Banner */}
      <div className="surface-card px-4 py-2.5 rounded-xl border border-cyan-500/20 bg-cyan-500/[0.03] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="font-semibold text-xs text-cyan-400 mr-2">Your security is our priority</span>
        ...
        <Link
          href="/risk"
          className="shrink-0 px-3 py-1.5 rounded-lg border border-cyan-500/30 text-[11px] text-cyan-400 font-medium hover:bg-cyan-500/10 transition-all"
        >
          Learn more
        </Link>
      </div>
...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-3.5 max-w-6xl">
      {/* Header */}
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground transition-colors px-2.5 py-1 rounded-lg hover:bg-white/5 border border-white/6"
        >
      ...
      {loading && showSkeleton && (
        <div className="space-y-4">
          ...
          <div className="surface-card overflow-hidden p-6 text-center space-y-3">
      ...
      {!loading && (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 animate-fade-in">
            <StatCard
              icon={
                <div className="w-5 h-5 rounded-md bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-cyan-400 shrink-0">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <StatCard
              icon={
                <div className="w-5 h-5 rounded-md bg-purple-500/10 border border-purple-500/20 flex items-center justify-center text-purple-400 shrink-0">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
