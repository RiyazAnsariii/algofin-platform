    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
        ...
        <div className="surface-card p-4 rounded-xl space-y-2 border border-white/6">
          ...
          <div>
            <p className="text-[11px] font-semibold text-foreground uppercase tracking-wider">High Impact</p>
            <p className="text-[11px] text-muted-foreground/60">{highCount > 0 ? `${highCount} upcoming` : "No events"}</p>
          </div>
        </div>
        ...
        <div className="surface-card p-4 rounded-xl space-y-2 border border-white/6">
          <div className="flex items-center gap-2.5">
            ...
            <p className="text-xl font-bold text-foreground">{medCount}</p>
          </div>
          <div>
            <p className="text-[11px] font-semibold text-foreground uppercase tracking-wider">Medium Impact</p>
            <p className="text-[11px] text-muted-foreground/60">{medCount > 0 ? `${medCount} upcoming` : "No events"}</p>
          </div>
        </div>
        ...
        <div className="surface-card p-4 rounded-xl space-y-2 border border-white/6">
          ...
          <div>
            <p className="text-[11px] font-semibold text-foreground uppercase tracking-wider">Low Impact</p>
            <p className="text-[11px] text-muted-foreground/60">{lowCount > 0 ? `${lowCount} upcoming` : "No events"}</p>
          </div>
        </div>
        ...
        <div className="surface-card p-4 rounded-xl space-y-2 border border-white/6">
          ...
          <div>
            <p className="text-[11px] font-semibold text-foreground uppercase tracking-wider">Total Events</p>
            <p className="text-[11px] text-muted-foreground/60">Next {daysAhead} days</p>
          </div>
        </div>
      </div>
      ...
      {loading ? (
        <div className="surface-card p-8 rounded-2xl border border-white/8 space-y-3">
          {[1, 2, 3].map((i) => (
        ...
        <div className="surface-card p-8 rounded-2xl border border-white/8 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden min-h-[220px]">
          <div className="flex-1 flex flex-col items-center justify-center text-center space-y-2.5 my-4">
            <div className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-muted-foreground shrink-0">
            ...
            <h3 className="text-base font-bold text-foreground">No upcoming events</h3>
      ...
      <div className="surface-card p-6 rounded-2xl border border-white/8 space-y-4">
        <div>
          <h2 className="text-xs font-semibold text-foreground uppercase tracking-wider">About Economic Events</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-1">
          ...
          <div className="flex items-start gap-3">
            <div className="w-9 h-9 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-400 flex items-center justify-center shrink-0">
      ...
      <div className="surface-card p-5 rounded-2xl border border-cyan-500/20 shadow-glow-cyan flex flex-col sm:flex-row items-center justify-between gap-4">
