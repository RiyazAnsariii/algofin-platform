...
from app.workers.sync_engine import sync_balances, sync_full, sync_positions, sync_trades
...
async def _run_sync_for_account(account_id: str, sync_type: str, triggered_by: str = "scheduler"):
    ...
    async with async_session() as db:
        ...
        if account is None:
            logger.warning(f"Account {account_id} not found or inactive — skipping sync")
            return
...
def sync_account(self, account_id: str, sync_type: str = "full", triggered_by: str = "scheduler"):
