...
async def main():
    ...
    dtos, status = await tv.fetch_events(date(2026, 7, 30), date(2026, 7, 30))
    print(f"=== TradingView Provider Events for Jul 30, 2026 ({len(dtos)} events) ===")
    for dto in dtos:
